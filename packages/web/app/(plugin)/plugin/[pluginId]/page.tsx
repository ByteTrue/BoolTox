...
export default function PluginRunPage({ params }: { params: Promise<{ pluginId: string }> }) {
  ...
  if (!isAvailable) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 pt-16">
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 pt-16">
        <div className="text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-400">加载插件中...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 pt-16">
        <div className="text-center max-w-md">
          ...
          <div className="flex gap-4 justify-center">
            <button
              onClick={() => router.back()}
              className="px-6 py-3 rounded-lg border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium hover:bg-neutral-50 dark:hover:bg-neutral-800"
            >
              返回
            </button>
            <button
  ...
  // 插件 UI 容器（全屏模式）
  return (
    <div className="fixed inset-0 bg-white dark:bg-neutral-950 flex flex-col pt-16">
      {/* 顶部工具栏 */}
