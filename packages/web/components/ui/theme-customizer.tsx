  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-40 p-4 rounded-full bg-primary-500 text-white shadow-soft-lg hover:shadow-soft-lg transition-all"
        title="主题定制 (Cmd+T)"
        aria-label="打开主题定制器"
      >
        <Palette size={20} />
                        ...
                        >
                          ...
                          {accentColor === option.id && (
                            <motion.div
                              ...
                              className="absolute top-2 right-2 w-5 h-5 bg-white dark:bg-neutral-900 rounded-full flex items-center justify-center"
                            >
                              <div
