...
import type { BooltoxAPI, BooltoxBackendMessage, BooltoxEncoding, ToolBackendConfig } from '@booltox/shared';
...
const booltoxAPI = {
  ...
  backend: {
    ...
    register: (definition?: ToolBackendConfig) => callAPI('backend', 'register', definition),
