  ...
  return useMemo(
    () => ({
      ...
      semantic: {
        ...
        successBg: isDark
          ? AppleColors.semantic.success.bg.dark
          : AppleColors.semantic.success.bg.light,
        successBorder: isDark
          ? AppleColors.semantic.success.border.dark
          : AppleColors.semantic.success.border.light,

        warning: isDark ? AppleColors.semantic.warning.dark : AppleColors.semantic.warning.light,
        warningBg: isDark
          ? AppleColors.semantic.warning.bg.dark
          : AppleColors.semantic.warning.bg.light,
        warningBorder: isDark
          ? AppleColors.semantic.warning.border.dark
          : AppleColors.semantic.warning.border.light,
        ...
        errorBorder: isDark
          ? AppleColors.semantic.error.border.dark
          : AppleColors.semantic.error.border.light,
        ...
        infoBorder: isDark
          ? AppleColors.semantic.info.border.dark
          : AppleColors.semantic.info.border.light,
      },
